...
public class PlayerTouchingWallState : PlayerState
{
    ...
    public PlayerTouchingWallState(Player player, PlayerStateMashine stateMashine, PlayerData playerData, string animBoolName) : base(player, stateMashine, playerData, animBoolName)
    {
    }
